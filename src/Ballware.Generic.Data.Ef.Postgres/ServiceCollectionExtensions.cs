...
using Ballware.Generic.Data.Ef.Postgres.Internal;
using Ballware.Generic.Data.Ef.Postgres.Model;
...
{
    public static IServiceCollection AddBallwareTenantStorageForPostgres(this IServiceCollection services, StorageOptions options, string connectionString)
    {
        ...
        services.AddDbContext<TenantDbContext>(o =>
        {
            ...
            o.ReplaceService<IModelCustomizer, PostgresTenantModelCustomizer>();
        });
