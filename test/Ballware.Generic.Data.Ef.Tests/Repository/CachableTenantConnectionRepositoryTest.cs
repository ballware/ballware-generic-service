...
[TestFixture]
public class CachableTenantConnectionRepositoryTest : RepositoryBaseTest
{
    ...
    public async Task Save_and_remove_value_succeeds()
    {
        ...
        var serializedExpectedValue = Encoding.UTF8.GetBytes(JsonConvert.SerializeObject(expectedValue));
    ...
    protected override void PrepareApplication(WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddBallwareTenantStorage(storageOptions, MasterConnectionString);
