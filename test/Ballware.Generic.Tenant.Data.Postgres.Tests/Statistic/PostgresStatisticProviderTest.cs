...
namespace Ballware.Generic.Tenant.Data.Postgres.Tests.Statistic;
...
public class PostgresStatisticProviderTest : DatabaseBackedBaseTest
{
    ...
    public async Task FetchData_succeeds()
    {
        ...
        var statistic = new Metadata.Statistic()
        {
            ...
            FetchSql = "select uuid as id, name, additional_param as AdditionalParam from testentity where tenant_id=@tenant_id order by name",
        };
